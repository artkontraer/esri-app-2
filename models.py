...
class SampleLocation(db.Model):
    ...
    id = Column(Integer, primary_key=True) #first column of the the table. the key identifies the row of the table uniquely. usually numbers        
    description = Column(String(80)) #80 is the length of the descripton of the location
